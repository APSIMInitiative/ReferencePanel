...
### 2.1 Check for new APSIM Major Improvements
   ...
   Simple model - water and N balance.  Keith to link Hamish with XX who worked on a banana model.  
   Hamish may be able to include the banana modeil into next gen
...
### 2.2  Updates from RP on models and reviews 
  ...
  - Models currently under review -https://github.com/APSIMInitiative/ApsimX/labels/underreview
    - [Fodder beet model](https://github.com/APSIMInitiative/ApsimX/issues/78) - Sitting with Rob; Hamish provided an update - no progress
    ...
    - any new models requiring review?<br>Models/Updates in release since last RP meeting
      - [AgPasture](https://github.com/APSIMInitiative/ApsimX/issues/3689) - Drew Holzworth now working with Jason on the Sorghum.  Jason provided an update; still debugging.. 
...
5.	Considering high performance computing needs and potential implications.  Recommendation - First step would be to collate what everyone is doing.  To ensure APSIM Infrastruture can deal with the high perforamnce computer.  
